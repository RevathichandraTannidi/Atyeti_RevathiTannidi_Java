package org.atyeti.java.tradeEngine;

import org.atyeti.java.tradeEngine.book.OrderBookManager;
import org.atyeti.java.tradeEngine.fileHandling.CsvParser;
import org.atyeti.java.tradeEngine.matchingEngine.MatchingEngine;
import org.atyeti.java.tradeEngine.matchingEngine.PriceTimePriorityStrategy;
import org.atyeti.java.tradeEngine.model.*;
import org.atyeti.java.tradeEngine.validation.*;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String buyFile = "src/main/resources/buy_orders.csv";
        String sellFile = "src/main/resources/sell_orders.csv";
        ...
        // Matching engine using priceTimePriority strategy
        MatchingEngine engine = new MatchingEngine(new PriceTimePriorityStrategy());
        logger.info(" STARTING ORDER MATCHING --->");

        for (Orders order : validOrders) { // all valid orders using matching engine
            engine.processOrder(
